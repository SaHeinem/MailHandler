...
class ClientSecretAdmin(admin.ModelAdmin):
  ...
  def get_exclude(self, request, obj=None):
    if obj:  # This means the object is being updated, so exclude the client_secret field
...
class MailboxAdmin(admin.ModelAdmin):
  form = MailboxForm
  list_display = ('name', 'client', 'default_jira_issue_type', 'created_at', 'updated_at')
